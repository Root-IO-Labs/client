...
class SecurityfindingsSecurityFindingActivitySummaryResource(BaseModel):
    """
    SecurityfindingsSecurityFindingActivitySummaryResource
    """ # noqa: E501
    number_of_comments: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["number_of_comments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "number_of_comments": obj.get("number_of_comments")
        })
        return _obj
