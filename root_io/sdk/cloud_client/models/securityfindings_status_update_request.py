...
class SecurityfindingsStatusUpdateRequest(BaseModel):
    """
    SecurityfindingsStatusUpdateRequest
    """ # noqa: E501
    resolution: Optional[EntitiesResolution] = Field(default=None, description="nolint: lll")
    status: Optional[EntitiesFindingStatus] = None
    __properties: ClassVar[List[str]] = ["resolution", "status"]
